        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- O formulário de criação deve usar o método POST para a rota tasks.store -->
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div>
                            ...
                            <!-- Usa old('title') para manter o valor em caso de erro de validação -->
                        ...
                        <div class="mt-4">
                            ...
                            <!-- Usa old('description') para manter o valor em caso de erro de validação -->
